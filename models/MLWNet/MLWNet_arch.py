...
from models.MLWNet.arch_util import LayerNorm2d
from einops import rearrange
import torch.nn.functional as F

from models.MLWNet.local_arch import Local_Base
from models.MLWNet.wavelet_block import LWN
...
if __name__ == '__main__':
    ...
    model = WaveletBlock(c=128).eval().cuda()
    summary(model, (1, 128, 64, 64), col_names=("input_size", "output_size", "num_params", "kernel_size", "mult_adds"))
    with torch.no_grad():
        a = model(img)
    # print(models.get_wavelet_loss())
    print(a[0].shape)
    exit(-1)
