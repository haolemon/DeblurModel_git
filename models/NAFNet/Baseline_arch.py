...
from models.NAFNet.model_utils import LayerNorm2d, Local_Base
...
class Baseline(nn.Module):
    ...
    def __init__(self, img_channel=3, width=16, middle_blk_num=1, enc_blk_nums=[], dec_blk_nums=[], dw_expand=1,
                 ffn_expand=2):
        super().__init__()
        self.width = width
        self.num_layers = 37
